...
\section{泰勒展开式}
\begin{itemize}
    \item $e^x$ 的泰勒展开：$e^x = 1 + x + \dfrac{x^2}{2!} + \dfrac{x^3}{3!} + \cdots + \dfrac{x^n}{n!} + \cdots$.
    \item $\sin x$ 的泰勒展开：$\sin x = x - \dfrac{x^3}{3!} + \dfrac{x^5}{5!} + \cdots + (-1)^n \dfrac{x^{2n+1}}{(2n+1)!} + \cdots$.
    \item $\cos x$ 的泰勒展开：$\cos x = 1 - \dfrac{x^2}{2!} + \dfrac{x^4}{4!} + \cdots + (-1)^n \dfrac{x^{2n}}{(2n)!} + \cdots$.
    \item $\ln(1 + x)$ 的泰勒展开：$\ln(1 + x) = x - \dfrac{x^2}{2} + \dfrac{x^3}{3} - \cdots + (-1)^{n-1} \dfrac{x^n}{n} + \cdots$.
    \item $(1 + x)^{\alpha}$ 的泰勒展开：$(1 + x)^{\alpha} = 1 + \alpha x + \dfrac{\alpha(\alpha - 1)}{2!}x^2 + \cdots + \binom{\alpha}{n} x^n + \cdots$, 其中 $\binom{\alpha}{n} = \dfrac{\alpha(\alpha - 1)\cdots(\alpha - n + 1)}{n!}$.
    \item $\arctan x$ 的泰勒展开：$\arctan x = x - \dfrac{x^3}{3} + \dfrac{x^5}{5} - \cdots + (-1)^n \dfrac{x^{2n+1}}{2n+1} + \cdots$.
    \item $\arcsin x$ 的泰勒展开：$\arcsin x = x + \dfrac{(2)!}{4^1 (1!)^2 \cdot 3}x^3 + \dfrac{(4)!}{4^2 (2!)^2 \cdot 5}x^5 + \cdots + \dfrac{(2n)!}{4^n (n!)^2 (2n + 1)} x^{2n+1} + \cdots$.
    \item $\arccos x$ 的泰勒展开：$\arccos x = \dfrac{\pi}{2} - x - \dfrac{(2)!}{4^1 (1!)^2 \cdot 3}x^3 - \dfrac{(4)!}{4^2 (2!)^2 \cdot 5}x^5 - \cdots - \dfrac{(2n)!}{4^n (n!)^2 (2n + 1)} x^{2n+1} + \cdots$.
    \item 双曲函数 $\sinh x$ 的泰勒展开：$\sinh x = x + \dfrac{x^3}{3!} + \dfrac{x^5}{5!} + \cdots + \dfrac{x^{2n+1}}{(2n+1)!} + \cdots$.
    \item 双曲函数 $\cosh x$ 的泰勒展开：$\cosh x = 1 + \dfrac{x^2}{2!} + \dfrac{x^4}{4!} + \cdots + \dfrac{x^{2n}}{(2n)!} + \cdots$.
\end{itemize}
...
\section{极限的计算}
\begin{theorem}[极限的计算方法]
四则运算

洛必达法则：注意其条件的充分性

泰勒公式：当 $x \to 0$ 时, 若 $f(x)$ 在 $x = 0$ 处具有 $n$ 阶可导数, 且 $f(0) = f'(0) = \cdots = f^{(n-1)}(0) = 0$, 则
\[
...
两个重要极限：$\lim_{x \to 0} \dfrac{\sin x}{x} = 1$ 和 $\lim_{x \to \infty}\left(1 + \dfrac{1}{x}\right)^{x} = e$.
\end{theorem}
